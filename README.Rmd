...
1. wfo_name contains the string of the full name as WFO has it. 
1. wfo_method contains a flag of how the name match was made, automatically or manually.
1. wfo_path contains the taxonomic path to the name in the current WFO classification. This is a sanity check to be sure you haven't matched your orchid name against a bryophyte by mistake!
